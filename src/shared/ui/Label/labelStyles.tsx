/**
 * @fileOverview Styles for Label Component
 * @description This file provides style definitions for the Label component, offering
 ...
 *              and scaling the UI design of the Label component. The styles are designed
...
/**
 * Retrieves the default style for Label.
 */
export const getLabelStyles = (props: LabelProps, color: string) => {
